# <img src="logo.svg" alt="Halter" height="128px">
...
This repository contains the Halter core smart contracts, including the `Vault` and standard Pools, along with their tests, configuration, and deployment information.
