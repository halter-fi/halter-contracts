...
describe('Halter Staking Unlocked', function () {
  before(async function () {
    ...
    this.HalterStaking = await ethers.getContractFactory('HalterStakingUnlocked');
  ...
  context('Testing withdraw calculations, mutations and actions: ', function () {
    ...
    beforeEach(async function () {
      ...
      await this.halterStaking.connect(this.alice).withdraw(aliceStake / 2, '2');
    ...
    it('Should correctly remove staked amount from the field', async function () {
      ...
      await this.halterStaking.connect(this.alice).withdraw(5, '2');
    ...
    it('Should correctly calculate userStake', async function () {
      ...
      await this.halterStaking.connect(this.alice).withdraw(aliceWithdrawBefore, '2');
    ...
    it('Should withdraw tokens', async function () {
      ...
      await this.halterStaking.connect(this.alice).withdraw(aliceWithdrawBefore, '3');
